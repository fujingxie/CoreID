...
CREATE TABLE IF NOT EXISTS landing_pages (
    ...
    draft_html_path VARCHAR(500),
    published_html_path VARCHAR(500),
...
CREATE TABLE IF NOT EXISTS purchases (
    ...
    purchase_mode VARCHAR(20) DEFAULT 'new',
...
CREATE INDEX IF NOT EXISTS idx_user_app_memberships_user ON user_app_memberships(user_id, app_id);
CREATE INDEX IF NOT EXISTS idx_user_app_memberships_app ON user_app_memberships(app_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_operation_logs_created_at ON operation_logs(created_at DESC);
CREATE INDEX IF NOT EXISTS idx_user_events_user_created_at ON user_events(user_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_app_release_versions_lookup ON app_release_versions(app_id, type, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_release_download_logs_release ON release_download_logs(app_id, type, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_release_download_logs_version ON release_download_logs(version_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_landing_page_versions_lookup ON landing_page_versions(app_id, published_at DESC);
CREATE INDEX IF NOT EXISTS idx_app_plans_lookup ON app_plans(app_id, status, sort_order, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_verification_codes_lookup ON verification_codes(app_id, phone, purpose, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_redeem_code_batches_app_created_at ON redeem_code_batches(app_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_redeem_codes_batch_created_at ON redeem_codes(batch_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_redeem_codes_user_created_at ON redeem_codes(redeemed_by_user_id, redeemed_at DESC);
CREATE INDEX IF NOT EXISTS idx_redeem_events_batch_created_at ON redeem_events(batch_id, created_at DESC);
